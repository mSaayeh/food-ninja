...
class _$MainStateImpl implements _MainState {
  const _$MainStateImpl({required this.currentTheme});
  ...
  @override
  String toString() {
    return 'MainState(currentTheme: $currentTheme)';
  }
...
abstract class _MainState implements MainState {
  const factory _MainState({required final ThemeData currentTheme}) =
      _$MainStateImpl;
